      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
        <div>
          ...
          <ul className="space-y-2 mt-4">
            <li><Link to="/all-models" className="text-gray-700 dark:text-gray-200 hover:text-blue-800">All Foods</Link></li>
            <li><Link to="/add-model" className="text-gray-700 dark:text-gray-200 hover:text-blue-800">Add Food</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/resources" className="text-gray-600 dark:text-gray-200 hover:text-blue-800">Resources</Link></li>
          </ul>
        </div>
